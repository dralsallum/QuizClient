...
export const ArWra = styled.section`
  display: flex;
  background: url(https://d1t11jpd823i7r.cloudfront.net/homepage/slider-desk-bg.png);
  ...
  @media screen and (max-width: 759px) {
    background: url(https://d1t11jpd823i7r.cloudfront.net/homepage/slider-mobile-bg.png);
    background-size: 100%;
    background-repeat: no-repeat;
    height: auto;
    position: relative;
